...
export default function CourseContent(){
    const {store} = useContext(CourseEditingContext);
    const section_AddedClicked = (e) =>{
                            ...
                            store.course.sections?store.course.sections.map((section,index)=>
                                <Card>
                                    ...
                                    <Card.Body>
                                        ...
                                        ):(<div>Empty<Button onClick={(e)=>section_AddedClicked(e)} value={section.section_id} variant="success">section ID: {section.section_id}</Button></div>)}
                                        </Accordion>
                                    </Card.Body>
                                    </Accordion.Collapse>
                                </Card>
