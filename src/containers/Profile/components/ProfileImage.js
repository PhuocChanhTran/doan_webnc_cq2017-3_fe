...
export default function ProfileImage() {
  ...
  //   Khai báo thêm 1 confirm password
  ...
  //   Hàm xử lý việc thay đổi password
  ...
  //   Hàm xử lý việc thay đổi password cũ
  ...
  //   Hàm kiểm tra password với confirm có trùng không
  ...
  //   Hàm submit form change password
  const handleSubmitEmail = () => {
    const res = updateEmail(email);
    res.then((res) => {
      if (res.status === 201) {
  ...
  //   Hàm clear email, newpassword, oldpassword, confirm
  const clear = () => {
    setConfirm("");
    setNewPassword("");
    setOldPassword("");
        ...
        <div>
          <div class="media d-block d-sm-flex align-items-center">
            ...
            <div class="media-body pl-sm-3 text-center text-sm-left">
              <button
                class="btn btn-rounded btn-outline-primary btn-sm px-3 mb-2"
                type="button"
                onClick={handleShow}
              >
              ...
              <button
                ...
                onClick={handleShow}
              >
                <i class="icon icon-sync"></i> Change Email Password
              </button>
              <div>
